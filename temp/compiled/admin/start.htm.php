...
?>
    ...
    <div class="content-left">
      <!-- $Id: start.htm 17216 2014-05-12 06:03:12Z pangbin $ -->
      <h1>
        <span class="action-span1"><a href="index.php?act=main">整体营销概况</a> </span>
        <div style="clear:both"></div>
      </h1>
      <!-- start personal message -->
      <?php if ($this->_var['admin_msg']): ?>
...
?>
      ...
      <div class="tab-div">
        <div id="tabbody-div">
          <ul>
              <li class="order-li"><a href="users.php?act=list">会员总数<strong><?php echo $this->_var['table']['all']['user_nums']; ?></strong></a></li>
              <li class="order-li"><a href="order.php?act=team_list&team_status=2">共成团<strong><?php echo $this->_var['table']['all']['group_success_nums']; ?></strong></a></li>
              <li class="order-li"><a href="order.php?act=team_list&team_status=3">拼团失败<strong><?php echo $this->_var['table']['all']['group_failed_nums']; ?></strong></a></li>
              <li class="order-li"><a href="order.php?act=list">总成交额<strong><?php echo empty($this->_var['table']['all']['amount']) ? '0.00' : $this->_var['table']['all']['amount']; ?></strong></a></li>
          </ul>
        </div>
      </div>
      <h1>
        <span class="action-span1"><a href="index.php?act=main">昨日营销概况</a> </span>
        <div style="clear:both"></div>
      </h1>
      <div class="tab-div">
        <div id="tabbody-div">
          <ul>
              <li class="order-li"><a href="users.php?act=list">会员总数<strong><?php echo $this->_var['table']['yesterday']['user_nums']; ?></strong></a></li>
              <li class="order-li"><a href="order.php?act=team_list&team_status=2">共成团<strong><?php echo $this->_var['table']['yesterday']['group_success_nums']; ?></strong></a></li>
              <li class="order-li"><a href="order.php?act=team_list&team_status=3">拼团失败<strong><?php echo $this->_var['table']['yesterday']['group_failed_nums']; ?></strong></a></li>
              <li class="order-li"><a href="order.php?act=list">总成交额<strong><?php echo empty($this->_var['table']['yesterday']['amount']) ? '0.00' : $this->_var['table']['yesterday']['amount']; ?></strong></a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="tab-div">
        <div id="tabbody-div">
          <ul>
            <li class="order-li"><a href="distribution.php?act=list">总金额<strong><?php echo empty($this->_var['table']['fenxiao']['all_money']) ? '0.00' : $this->_var['table']['fenxiao']['all_money']; ?></strong></a></li>
            <li class="order-li"><a href="distribution.php?act=list&dstatus=1">有效金额<strong><?php echo empty($this->_var['table']['fenxiao']['all_allow']) ? '0.00' : $this->_var['table']['fenxiao']['all_allow']; ?></strong></a></li>
            <li class="order-li"><a href="distribution.php?act=list">当月总金额<strong><?php echo empty($this->_var['table']['fenxiao']['mon_money']) ? '0.00' : $this->_var['table']['fenxiao']['mon_money']; ?></strong></a></li>
            <li class="order-li"><a href="distribution.php?act=list&dstatus=1">当月有效金额<strong><?php echo empty($this->_var['table']['fenxiao']['mon_allow']) ? '0.00' : $this->_var['table']['fenxiao']['mon_allow']; ?></strong></a></li>
          </ul>
        </div>
      </div>
    </div>    
