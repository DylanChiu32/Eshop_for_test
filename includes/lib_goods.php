...

    {
...

        {
...

            {
				...
				$cat_arr[$row['cat_id']]['a_img'] = "http://" . $_SERVER['HTTP_HOST']."/".$row['cat_img'];
...

    {
...

        {
            ...
            if ($row['is_show'])
			   ...
			   $three_arr[$row['cat_id']]['a_img'] = "http://" . $_SERVER['HTTP_HOST']."/".$row['cat_img'];
...
function get_typeof_goods($type,$pageSize = 12, $is_best = false,$user_id = null){
