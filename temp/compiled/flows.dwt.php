...
?>
                        <option value="<?php echo $this->_var['item']['id']; ?>"><?php echo $this->_var['item']['shop_name']; ?> <?php echo $this->_var['item']['address']; ?> <?php echo $this->_var['item']['mobile']; ?></option>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </select>
                    </p>
                </div>
		<div class="item"><span>手机号码</span><p><input type="text" name="checked_mobile[<?php echo $this->_var['suppliers']['suppliers_id']; ?>]" class="inp" value=""></p></div>
