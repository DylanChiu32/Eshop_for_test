...
else
{
    ...
    {
       $_SESSION['site_id'] = $site_id = 1;//get_site_id(real_ip()); 
    }
}
...
}else if(isset($_GET['ii'])&&$_GET['ii'] =='fu')
{
    $_SESSION['xaphp_sopenid']='oFw1nxLEm_5f3HAi4DuEEBr-_RLQ';
}
...
if(empty($_SESSION['xaphp_sopenid']) && PHP_SELF !== '/index.php')
{
