...
function get_attr_list($cat_id, $goods_id = 0)
{
    ...
    // 查询属性值及商品的属性值
    $sql = "SELECT a.attr_id, a.attr_name, a.attr_input_type, a.attr_type, a.attr_values, v.attr_value, v.attr_price, v.attr_team_price ".
...
function goods_list($is_delete, $real_goods=1, $conditions = '')
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT is_luck,is_miao,is_fresh,is_tejia,is_mall,is_zero,is_team,team_num,team_price,limit_buy_one,goods_id,sales_num, goods_name, goods_type, goods_sn, shop_price, is_on_sale,is_check, is_best, is_new, is_hot, sort_order, goods_number, integral, " .
