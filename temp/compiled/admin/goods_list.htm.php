...
?>
  <tr>
    ...
    <?php if ($this->_var['use_storage']): ?>
    <td align="center"><span <?php if ($this->_var['goods']['is_luck'] == 0): ?> onclick="listTable.edit(this, 'edit_goods_number', <?php echo $this->_var['goods']['goods_id']; ?>)"<?php endif; ?>><?php echo $this->_var['goods']['goods_number']; ?></span></td>
    <?php endif; ?>
    <td width="200" class="bnt_a">
<a href="../goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>&ii=lii" target="_blank">预览</a>
      <a href="goods.php?act=edit&goods_id=<?php echo $this->_var['goods']['goods_id']; ?><?php if ($this->_var['code'] != 'real_goods'): ?>&extension_code=<?php echo $this->_var['code']; ?><?php endif; ?>&page=<?php echo $this->_var['filter']['page']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><?php echo $this->_var['lang']['edit']; ?></a>
      ...
      <a href="goods.php?act=product_list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" title="<?php echo $this->_var['lang']['item_list']; ?>"><?php echo $this->_var['lang']['item_list']; ?></a><?php endif; ?>
