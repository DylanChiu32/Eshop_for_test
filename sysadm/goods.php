...

        {
...

            {
...

                {
                    ...
                    $sql = "INSERT INTO " .$hhs->table('goods_attr'). " (attr_id, goods_id, attr_value, attr_price, attr_team_price)".

                            "VALUES ('$attr_id', '$goods_id', '$attr_value', '$info[attr_price]', '$info[attr_team_price]')";
...

                {
                    ...
                    $sql = "UPDATE " .$hhs->table('goods_attr'). " SET attr_price = '$info[attr_price]',attr_team_price = '$info[attr_team_price]' WHERE goods_attr_id = '$info[goods_attr_id]' LIMIT 1";
