...

{
    ...
    $sql = "INSERT INTO ".$hhs->table('ad'). " (ad_width,city_id,position_id,media_type,ad_name,ad_link,ad_code,start_time,end_time,link_man,link_email,link_phone,click_count,enabled)
