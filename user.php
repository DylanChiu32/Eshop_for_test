...
array('login','act_login','weixin_login','register','act_register','act_edit_password','get_password','send_pwd_email','password', 'signin', 'add_tag', 'collect','collect_store', 'return_to_cart', 'logout', 'email_list', 'validate_email', 'send_hash_mail', 'order_query', 'is_registered', 'check_email','clear_history','qpassword_name', 'get_passwd_question', 'check_answer', 'oath' , 'oath_login', 'other_login');
...
{  
    ...
    if($pay_code=='wxpay'){
            ...
            $order=array('goods_name'=>'会员充值','order_amount'=>$money, 'order_sn' => time().rand(99,9999));
        ...
        $result = array( 'error'    => 0, 'pay_code'=>$pay_code,'m'=>$money);
