...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      ...
      <p>
        ...
        <span class="tab-back" id="shipping-tab">运费设置</span>
...
?>
          ...
          <tr>
            ...
            <td>
              ...
              <input type="checkbox" id="J_check2" onclick="clearBox(2)" name="is_team" value="1" <?php if ($this->_var['goods']['is_team'] == 1): ?>checked<?php endif; ?>>拼团



              <input type="checkbox" id="J_check3" onclick="clearBox(3)" name="is_zero" value="1" <?php if ($this->_var['goods']['is_zero'] == 1): ?>checked<?php endif; ?>>零元购
          ...
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_give_integral']; ?></td>
            <td><input type="text" name="give_integral" value="<?php echo $this->_var['goods']['give_integral']; ?>" size="20" />
            <span class="notice-span" id="giveIntegral"><?php echo $this->_var['lang']['notice_give_integral']; ?></span></td>
          </tr>
          <!--tr>
            <td class="label"><?php echo $this->_var['lang']['lab_integral']; ?></td>
            <td><input type="text" name="integral" value="<?php echo $this->_var['goods']['integral']; ?>" size="20" onblur="parseint_integral()";/>
              <span class="notice-span" id="noticPoints"><?php echo $this->_var['lang']['notice_integral']; ?></span>
            </td>
          </tr-->
          ...
          <tr>
            ...
            <td><input type="text" name="shipping_fee" value="<?php echo $this->_var['goods']['shipping_fee']; ?>" size="20" />
          ...
          <tr>
            ...
            <td class="label">是否允许分享得积分：</td>
            
            <td>
                <label><input type="radio" name="allow_sharej" value="1"<?php if ($this->_var['goods']['allow_sharej'] != 0): ?>checked='checked'<?php endif; ?> onclick="document.getElementById('jifen_row').style.display = ''">是</label>
                <label><input type="radio" name="allow_sharej" value="0"<?php if ($this->_var['goods']['allow_sharej'] == 0): ?>checked='checked'<?php endif; ?> onclick="document.getElementById('jifen_row').style.display = 'none'">否</label>
            </td>
          </tr>                
          <tr id="jifen_row" >
            <td class="label">分享赠送积分数量:</td>
            <td>
                <input type="text" name="share_j" value="<?php echo empty($this->_var['goods']['share_j']) ? '0' : $this->_var['goods']['share_j']; ?>">
            </td>
          </tr>     
         <script>
            <?php if ($this->_var['goods']['allow_fenxiao'] == 0): ?>
            document.getElementById('fenxiao_row').style.display = 'none'
            <?php endif; ?>
            <?php if ($this->_var['goods']['allow_sharej'] == 0): ?>
            document.getElementById('jifen_row').style.display = 'none'
            <?php endif; ?>
      ...
      <tr name="team_discount">
          ...
          <tr>
            ...
            <td>
                ...
                <label><input type="radio" name="is_miao" value="0"<?php if ($this->_var['goods']['is_miao'] == 0): ?>checked='checked'<?php endif; ?>>否</label>  <font color="red">和夺宝产品只能二选一,秒杀必须是单独购</font>
          ...
          <script type="text/javascript">
           ...
           <script type="text/javascript">
              ...
              $(document).ready(function(){
                    ...
                    jian_ting($("input[name='is_luck']:checked").val());

                    $("input[name='is_luck']").live('change', function(){

                     var is_luck =$("input[name='is_luck']:checked").val() ;
          ...
          <tr id="show">
            ...
            <td>
                ...
                <input type="text" name="promote_price" value="<?php echo empty($this->_var['goods']['promote_price']) ? '0.00' : $this->_var['goods']['promote_price']; ?>">
          ...
          <tr id="promote_4">
            ...
            <td id="promote_6">
              ...
              <input name="promote_start_date" type="text" id="promote_start_date" size="25" value='<?php echo $this->_var['goods']['promote_start_date']; ?>' readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-M-d HH:mm'})" />

               - 

               <input name="promote_end_date" type="text" id="promote_end_date" size="25" value='<?php echo $this->_var['goods']['promote_end_date']; ?>' readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-M-d HH:mm'})" /> <font color="red">*</font>
         ...
         <!--<tr class="show">
          ...
          <tr class="show">
            ...
            <td class="label">每份价格：</td>

            <td>

                <input type="text" name="luck_price" value="<?php echo $this->_var['goods']['team_price']; ?>"> <font color="red"></font>
         ...
         <tr>
            ...
            <input type="radio" name="subscribe" value="1" <?php if ($this->_var['goods']['subscribe'] == 1): ?>checked="checked"<?php endif; ?>>是 &nbsp;若选择是，必须是关注的会员才能购买,记得去系统设置/商店设置上传公众号二维码或引导链接
...
?> -->
          ...
          <tr id="spe-5">
            ...
            <td>
              ...
              <input type="text" name="spe_step_fee" value="<?php echo $this->_var['goods']['spe_step_fee']; ?>" size="20" /><font color="red">按重量计算选填</font>
