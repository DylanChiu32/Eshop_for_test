...
<html lang="zh-CN">
<head>
<meta name="Generator" content="haohaipt v6.1" />
<meta charset="UTF-8">
...
?>
    ...
    <div class="tuan_info">
        <form action="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" method="post" name="HHS_FORMBUY" id="HHS_FORMBUY" >
            ...
            <div class="line"></div>
            <div class="blank"></div>
            <div class="td2_info"> <?php if ($this->_var['goods']['lab_qgby']): ?>
...
?>
            ...
            <div class="ftbuy"> <a href="index.php" class="ftbuy_index">
				...
				<a class="ftbuy_message" target="_blank" href="<?php echo $this->_var['qq']; ?>">
    ...
    <div class="mall_goods"> <a href="store.php?id=<?php echo $this->_var['goods']['suppliers_id']; ?>">
        <div class="mall_img"><img src="<?php if ($this->_var['stores_info']['supp_logo']): ?><?php echo $this->_var['stores_info']['supp_logo']; ?><?php else: ?>images/store_logo.jpg<?php endif; ?>"></div>
        <div class="mall_sub">
...
?>
            <div class="goods-comments-detail"> <img class="goods-comments-avatar" src="<?php if ($this->_var['item']['headimgurl']): ?><?php echo $this->_var['item']['headimgurl']; ?><?php else: ?>themes/haohainew/images/mr_head.png<?php endif; ?>">
    ...
    <div class="recommend_grid_wrap">
        <div id="recommend" class="grid">
            ...
            <div class="bd">
                <ul>
                    <?php $_from = $this->_var['rands_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_64052000_1491363748');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_64052000_1491363748']):
?>
                    <li>
                        <div class="recommend_img"><a href="goods.php?id=<?php echo $this->_var['goods_0_64052000_1491363748']['goods_id']; ?>"><img  src="<?php if ($this->_var['goods_0_64052000_1491363748']['goods_img']): ?><?php echo $this->_var['goods_0_64052000_1491363748']['goods_img']; ?><?php else: ?>images/no_picture.gif<?php endif; ?>"></a></div>
                        <div class="recommend_title"><a href="goods.php?id=<?php echo $this->_var['goods_0_64052000_1491363748']['goods_id']; ?>"><?php echo $this->_var['goods_0_64052000_1491363748']['goods_name']; ?></a></div>
                        <div class="recommend_price">￥<span><?php echo $this->_var['goods_0_64052000_1491363748']['goods_price']; ?></span></div>
                        <?php if ($this->_var['goods_0_64052000_1491363748']['rec_id'] > 0): ?>
                        <div class="like_click" data-id="<?php echo $this->_var['goods_0_64052000_1491363748']['goods_id']; ?>"><img src="themes/haohainew/images/is_liked2.png" data-isLiked="1"></div>
                        <?php else: ?>
                        <div class="like_click" data-id="<?php echo $this->_var['goods_0_64052000_1491363748']['goods_id']; ?>"> <img src="themes/haohainew/images/no_liked2.png" data-isLiked="0"></div>
                        <?php endif; ?>
                    </li>
                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </ul>
...
function changePriceResponse(res)
{
  ...
  else
  {
	...
	if(res.attr_name)
	{
	    document.getElementById('sku-msg').innerHTML = res.attr_name;
	}
