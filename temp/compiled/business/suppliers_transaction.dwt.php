    	...
    	<div class="contitleedit"><span>顾客提货</span></div>
			<div class="conbox" >
				...
				<table cellspacing="0" cellpadding="0" class="edittable">
					...
					<!-- 
					<tr>
                         <td class="right">扫描二维码验证：</td>
						<td>
						<img src="http://qr.liantu.com/api.php?text=<?php echo $this->_var['link']; ?>&w=100&m=10">
						</td>
					</tr>
					 -->
...
<?php else: ?>
    ...
    <td height="25"><?php if ($this->_var['delivery_order']['status'] != 1): ?><input name="invoice_no" type="text" value="<?php echo $this->_var['delivery_order']['invoice_no']; ?>" <?php if ($this->_var['delivery_order']['status'] == 0): ?> readonly="readonly" <?php endif; ?>><?php else: ?><?php echo $this->_var['delivery_order']['invoice_no']; ?><?php endif; ?></td>
<?php endif; ?>
  </tr></table><br />
...
document.getElementById('delivery_download').href="suppliers.php?act=delivery_download&shipping_type=0&"+str;

document.getElementById('delivery_print').href="suppliers.php?act=delivery_print&shipping_type=0&"+str;
...
?>
        <tr>
          ...
          <td><a href="suppliers.php?act=delivery_info&delivery_id=<?php echo $this->_var['delivery']['delivery_id']; ?>&shipping_type=0">详情</a> 
...
?>
					...
					<tr>
					  ...
					  <td align="center"><a href="?act=order_info&order_id=<?php echo $this->_var['order_list']['order_id']; ?>"><?php echo $this->_var['order_list']['order_sn']; ?><?php if ($this->_var['order_list']['extension_code'] == 'team_goods'): ?><span style="color:#F00;">[团]</span><?php endif; ?><?php if ($this->_var['order_list']['team_first'] == 1): ?> <font color="red">[团长]</font> <?php endif; ?></a></td>

                      <td align="center"><?php echo $this->_var['order_list']['buyer']; ?><br /><?php echo $this->_var['order_list']['short_order_time']; ?></td>

                      <td align="center"><?php echo $this->_var['order_list']['consignee']; ?><?php if ($this->_var['order_list']['point_id'] == 0): ?>[TEL:<?php if ($this->_var['order_list']['mobile']): ?><?php echo $this->_var['order_list']['mobile']; ?><?php else: ?><?php echo $this->_var['order_list']['tel']; ?><?php endif; ?>]<br /><?php echo $this->_var['order_list']['address']; ?><?php endif; ?></td>
					  <td align="center"><?php echo $this->_var['order_list']['goods_num']; ?></td>
                      <td align="center"><?php echo $this->_var['order_list']['total_fee']; ?></td>

                      <td align="center"><?php echo $this->_var['order_list']['order_amount']; ?></td>
...
<table width="100%" cellpadding="3" cellspacing="1">
 ...
 <tr>
  ...
  <?php if ($this->_var['order']['discount_type']): ?>
  <tr>

    <td><div align="right"><strong>团长优惠：</strong></div></td>

    <td colspan="3">
    <?php if ($this->_var['order']['discount_type'] == 1): ?>团长免单<?php endif; ?>
    <?php if ($this->_var['order']['discount_type'] == 2): ?>价格优惠<?php endif; ?>
    </td>
...
<?php else: ?>
  <tr>
    ...
    <td><div align="right"><strong>自提点：</strong></div></td>

    <td><?php echo $this->_var['point_info']['region']; ?>，
<?php echo $this->_var['point_info']['address']; ?>，
<?php echo $this->_var['point_info']['shop_name']; ?>，
<?php echo $this->_var['point_info']['tel']; ?></td>

    <td><div align="right"><strong>验证电话：</strong></div></td>

    <td><?php echo htmlspecialchars($this->_var['order']['checked_mobile']); ?></td>
...
<div>
  ...
  <?php $_from = $this->_var['opt_action_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'action_0_52644600_1462859185');if (count($_from)):
    foreach ($_from AS $this->_var['action_0_52644600_1462859185']):
?>
  <tr>
    <td><div align="center"><?php echo $this->_var['action_0_52644600_1462859185']['action_user']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_52644600_1462859185']['action_time']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_52644600_1462859185']['order_status']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_52644600_1462859185']['pay_status']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_52644600_1462859185']['shipping_status']; ?></div></td>
    <td><?php echo nl2br($this->_var['action_0_52644600_1462859185']['action_note']); ?></td>
  </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
</div>
...
//			}
 	...
 	<div class="main" id="main">
		...
		<div class="maincon" style="color:#000;">
            ...
            <ul class="listtab">
        <li id='nav1'class="act" class="act"><a href="javascript:;" onclick="show_html(1,4);">详细描述</a></li>
...
?>
          ...
          <tr>
            ...
            <td>
              ...
              <input type="checkbox" name="is_mall" value="1" <?php if ($this->_var['goods']['is_mall'] == 1): ?>checked<?php endif; ?>>单独购
              <input type="checkbox" name="is_zero" value="1" <?php if ($this->_var['goods']['is_zero'] == 1): ?>checked<?php endif; ?>>零元购
              <input type="checkbox" name="is_team" value="1" <?php if ($this->_var['goods']['is_team'] == 1): ?>checked<?php endif; ?>>拼团
           ...
           <tr>
            ...
            <td><input type="text" name="goods_weight" value="<?php echo $this->_var['goods']['goods_weight_by_unit']; ?>" size="20" /> <select name="weight_unit"><?php echo $this->html_options(array('options'=>$this->_var['unit_list'],'selected'=>$this->_var['weight_unit'])); ?></select></td>
                    ...
                    <tr>
						...
						<td><input type="text" value="<?php echo $this->_var['goods']['goods_number']; ?>" name="goods_number" class="input" size="35">
                        </td>
					</tr>
					<tr>
          ...
          <tr>
            ...
            <td><select name="bonus_free_all"><option value="0">请选择</option>
...
?>
          ...
          <tr>
            ...
            <td>
                <label><input type="radio" name="allow_fenxiao" value="1"<?php if ($this->_var['goods']['allow_fenxiao'] != 0): ?>checked='checked'<?php endif; ?>>是</label>
                <label><input type="radio" name="allow_fenxiao" value="0"<?php if ($this->_var['goods']['allow_fenxiao'] == 0): ?>checked='checked'<?php endif; ?>>否</label>
            </td>
          </tr>     
          <tr>
            <td class="label">分销金额：</td>
            <td>
                一级<input type="text" name="rate_1" value="<?php echo empty($this->_var['goods']['rate_1']) ? '0' : $this->_var['goods']['rate_1']; ?>">
                二级<input type="text" name="rate_2" value="<?php echo empty($this->_var['goods']['rate_2']) ? '0' : $this->_var['goods']['rate_2']; ?>">
                三级<input type="text" name="rate_3" value="<?php echo empty($this->_var['goods']['rate_3']) ? '0' : $this->_var['goods']['rate_3']; ?>">
            </td>
          </tr>       
					<?php if (0): ?>
                     <tr>
          ...
          <tr>
            ...
            <table class="edittable">
				 <tr>
                        ...
                        <input name="act" type="hidden" value="<?php echo $this->_var['form_act']; ?>" />
                        <input name="express_items" type="hidden" value="" />
