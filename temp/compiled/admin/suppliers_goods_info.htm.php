        ...
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <tr>
           ...
           <tr>
            ...
            <td><select name="brand_id"  ><option value="0"><?php echo $this->_var['lang']['select_please']; ?><?php echo $this->html_options(array('options'=>$this->_var['brand_list'],'selected'=>$this->_var['goods']['brand_id'])); ?></select>
...
?>
      ...
      <tr name="team_discount">
            ...
            <td>
                ...
                <label><input type="radio" name="is_miao" onclick="jianting(1);" value="1"<?php if ($this->_var['goods']['is_miao'] != 0): ?>checked='checked'<?php endif; ?>>是</label>

                <label><input type="radio" name="is_miao" onclick="jianting(0);" value="0"<?php if ($this->_var['goods']['is_miao'] == 0): ?>checked='checked'<?php endif; ?>>否</label>  <font color="red">和夺宝产品只能二选一,秒杀必须是单独购</font>
          ...
          <tr id="show" <?php if ($this->_var['goods']['is_miao'] == 0 || $this->_var['goods']['is_miao'] == ''): ?> style="display:none;"<?php endif; ?>>
          ...
          <tr id="promote_4" <?php if ($this->_var['goods']['is_miao'] == 0 || $this->_var['goods']['is_miao'] == ''): ?> style="display:none;"<?php endif; ?>>
