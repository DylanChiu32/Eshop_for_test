...
function get_goodslist()
{
    ...
    if (!empty($keywords))
    {
        ...
        $sql = "select o.square,o.order_id,o.team_sign,o.team_num,o.teammen_num,(team_num - teammen_num) as need, o.add_time,u.uname,u.headimgurl from ".$hhs->table('order_info')." as o,".$hhs->table('order_goods')." as g,".$hhs->table('users')." as u where o.show_square = 1 and o.user_id = u.user_id AND g.`order_id` = o.`order_id` ".$where." order by " . $orderby;        // and o.team_status = 1 AND o.order_status = 1
    }
    else{
        $sql = "select o.square,o.order_id,o.team_sign,o.team_num,o.teammen_num,(team_num - teammen_num) as need, o.add_time,u.uname,u.headimgurl from ".$hhs->table('order_info')." as o,".$hhs->table('users')." as u where o.show_square = 1 and o.user_id = u.user_id  ".$where." order by " . $orderby; //and o.team_status = 1 AND o.order_status = 1
    }
