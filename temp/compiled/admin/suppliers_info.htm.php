...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/utils.js,../js/region.js,listtable.js')); ?>
  ...
  <tr>
    ...
    <td>  
      <select name="hangye_id" id="hangye_id">
        ...
        <?php $_from = $this->_var['hangye']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
        <option value="<?php echo $this->_var['item']['id']; ?>" <?php if ($this->_var['item']['id'] == $this->_var['suppliers']['hangye_id']): ?>selected="selected"<?php endif; ?>><?php echo $this->_var['item']['name']; ?></option>
        ...
        <!-- <?php if (0): ?> -->
         <tr>
           ...
           <!-- <?php endif; ?> -->
              ...
              <tr>
                <td class="label">平台佣金比例：</td>
                <td>
                <input name="percentage" type="text" size="20"  class="input"  value="<?php if ($this->_var['suppliers']['percentage'] > 0): ?><?php echo $this->_var['suppliers']['percentage']; ?><?php else: ?><?php echo $this->_var['cfg_percentage']; ?><?php endif; ?>" />
                <span style="color:#FF0000" id="percentage_notice"> %</span>
                </td>
              </tr>
<!--               <tr>
                <td class="label">一级分销佣金比例：</td>
                <td>
                <input name="rate_1" type="text" size="20"  class="input"  value="<?php if ($this->_var['suppliers']['rate_1']): ?><?php echo $this->_var['suppliers']['rate_1']; ?><?php else: ?>0.00<?php endif; ?>" />
                <span style="color:#FF0000" id="rate_1_notice"> %</span>
                </td>
              </tr>
              <tr>
                <td class="label">二级分销佣金比例：</td>
                <td>
                <input name="rate_2" type="text" size="20"  class="input"  value="<?php if ($this->_var['suppliers']['rate_2']): ?><?php echo $this->_var['suppliers']['rate_2']; ?><?php else: ?>0.00<?php endif; ?>" />
                <span style="color:#FF0000" id="rate_2_notice"> %</span>
                </td>
              </tr>
              <tr>
                <td class="label">三级分销佣金比例：</td>
                <td>
                <input name="rate_3" type="text" size="20"  class="input"  value="<?php if ($this->_var['suppliers']['rate_3']): ?><?php echo $this->_var['suppliers']['rate_3']; ?><?php else: ?>0.00<?php endif; ?>" />
                <span style="color:#FF0000" id="rate_3_notice"> %</span>
                </td>
              </tr> -->
...
function validate()
{
	if(document.theForm.suppliers_name.value=='')
	{
		alert('请添加商家名称');
		return false;
	}
