    ...
    <table align="center" width="400">
      <tr>
        <td width="50" valign="top">
          ...
          <img src="themes/haohaios/images/information.gif" width="32" height="32" border="0" alt="information" />
          <?php elseif ($this->_var['msg_type'] == 1): ?>
          <img src="themes/haohaios/images/warning.gif" width="32" height="32" border="0" alt="warning" />
          <?php else: ?>
          <img src="themes/haohaios/images/confirm.gif" width="32" height="32" border="0" alt="confirm" />
          <?php endif; ?>
        </td>
