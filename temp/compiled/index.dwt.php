...
<div class="container" id="container" style="display:none;">
    <div class="topbox">
        <header class="index-header"> 
            <div class="city_txt"><a href="javascript:void(0);"><i class="iconfont icon-weizhi"></i><b><?php echo $this->_var['site_name']; ?></b></a> </div>
   ...
   document.getElementById("leftTime"+key).innerHTML =a + b + c + d; //显示倒计时信息
    ...
    <div class="swiper-container" style="margin-top:56px;">
        <div class="swiper-wrapper">
		    <?php $_from = $this->_var['banner']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'banner_0_06302700_1490847077');if (count($_from)):
    foreach ($_from AS $this->_var['banner_0_06302700_1490847077']):
?>
            <div class="swiper-slide"><a href="<?php echo $this->_var['banner_0_06302700_1490847077']['ad_link']; ?>"><img src="<?php echo $this->_var['banner_0_06302700_1490847077']['ad_code']; ?>" width="100%"/></a></div>
...
?>
            <div class="tuan_g">
                <div class="tuan_g_img">
				    <a href="<?php if ($this->_var['goods']['goods_number'] > 0): ?><?php echo $this->_var['goods']['url']; ?>&uid=<?php echo $this->_var['uid']; ?><?php else: ?>javascript:void(0);<?php endif; ?>"> <img data-original="<?php echo $this->_var['goods']['little_img']; ?>" src="themes/haohainew/images/loading.gif" class="lazy"> </a>
...
if ($this->_foreach['goods_list']['total'] > 0):
    foreach ($_from AS $this->_var['goods']):
        $this->_foreach['goods_list']['iteration']++;
?>
            <li> <a href="<?php if ($this->_var['goods']['goods_number'] > 0): ?><?php echo $this->_var['goods']['url']; ?>&uid=<?php echo $this->_var['uid']; ?><?php else: ?>javascript:void(0);<?php endif; ?>"><img goods_id="<?php echo $this->_var['goods']['goods_id']; ?>" data-original="<?php echo $this->_var['goods']['goods_thumb']; ?>" src="themes/haohainew/images/loading.gif" class="lazy"></a>
                <p class="tit"><a href="<?php echo $this->_var['goods']['url']; ?>&uid=<?php echo $this->_var['uid']; ?>"><?php echo $this->_var['goods']['goods_name']; ?></a></p>
                <p>
