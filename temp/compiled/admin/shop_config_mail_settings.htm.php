...
<div class="main-div">
  <table width="100%" id="<?php echo $this->_var['group']['code']; ?>-table" class="table tb-type2">
...
?>
	...
	<tr>
      <td colspan="2" class="required"><label><?php echo $this->_var['lang']['cfg_name']['test_mail_address']; ?>:</label></td>
	</tr>
    <tr class="noborder">	
      <td colspan="2">
