...
function refund($order_sn,$refund_fee,$refund_surplus = true,$refund_bonus = true){
...

    {
    	...
    	order_refund($order_info, 1, '退款', $order_info['surplus']);

    	if($order_info['surplus'] == $order_info['order_amount'])
    ...
    if($order_info['money_paid'] == 0.00 || empty($order_info['transaction_id']))
