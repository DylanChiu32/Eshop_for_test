...
$_LANG['cfg_name']['ziti'] = '是否开启自提点';

$_LANG['cfg_desc']['sms_name'] = '短信接口申请地址 <a href="http://www.yunsms.cn/" target="_blank">http://www.yunsms.cn/</a>';

$_LANG['cfg_desc']['template'] = '目前两套模板(1. haohaios  2. haohai  3. haohainew )';
...
$_LANG['cfg_desc']['qq'] = '申请网址 <a href="http://www.aikf.com/" target="_blank">http://www.aikf.com/</a>';



$_LANG['cfg_name']['dbgz'] = '夺宝规则';
...
$_LANG['cfg_range']['ziti']['1'] = '开启';

$_LANG['cfg_range']['ziti']['0'] = '关闭';
...
$_LANG['gzip_confirm'] = "GZip 功能需要您的服务器支持 zlib 扩展库。\\n如果您发现开启Gzip后页面出现乱码，可能是您的服务器已经开启了Gzip，您不需要在 集果轩电商 中再次开启。";
...
$_LANG['cfg_name']['store_share_desc'] = '商家店铺分享描述';

$_LANG['cfg_name']['user_share_desc'] = '个人分销页面分享描述';



$_LANG['cfg_name']['hb_share_title'] = '抢现金红包分享标题';

$_LANG['cfg_name']['hb_share_dec'] = '抢现金红包分享描述';





$_LANG['cfg_name']['db_title'] = '夺宝详情分享标题';

$_LANG['cfg_name']['db_desc'] = '夺宝详情分享描述';



$_LANG['cfg_name']['mall_title'] = '商城分享标题';

$_LANG['cfg_name']['mall_desc'] = '商城分享描述';



$_LANG['cfg_name']['tuan_title'] = '拼团分享标题';

$_LANG['cfg_name']['tuan_desc'] = '拼团分享描述';



$_LANG['cfg_name']['square_title'] = '广场分享标题';

$_LANG['cfg_name']['square_desc'] = '广场分享描述';
...
$_LANG['cfg_name']['auto_cancel'] = '自提提醒取消订单';

$_LANG['cfg_desc']['auto_cancel'] =  '以天为单位';
...
$_LANG['cfg_name']['rate_1'] =  '一级分销佣金比例（%）';

$_LANG['cfg_name']['rate_2'] =  '二级分销佣金比例（%）';

$_LANG['cfg_name']['rate_3'] =  '三级分销佣金比例（%）';



$_LANG['cfg_name']['send_bonus_time'] = '购物发优惠券时间';

$_LANG['cfg_range']['send_bonus_time']['0'] = '团购成功时发';

$_LANG['cfg_range']['send_bonus_time']['1'] = '收货之后发';

$_LANG['cfg_range']['send_bonus_time']['2'] = '支付之后发';



$_LANG['cfg_name']['bonus_ad'] = '优惠券封面广告';

$_LANG['cfg_name']['share_bg'] = '分销二维码背景图片';

$_LANG['cfg_desc']['share_bg'] =  '请上传jpg格式背景图片';

$_LANG['cfg_name']['x_pos'] = '分销二维码X坐标';

$_LANG['cfg_name']['y_pos'] =  '分销二维码Y坐标';



$_LANG['cfg_name']['business_login_logo'] = '商家登陆页LOGO';

$_LANG['cfg_name']['business_logo'] = '商家后台LOGO';



$_LANG['cfg_desc']['business_login_logo'] =  '请上传png格式背景图片,宽高建议462*36';

$_LANG['cfg_desc']['business_logo'] =  '请上传png格式背景图片,宽高建议215*57';



$_LANG['cfg_name']['share_img'] = '分享水印图';

$_LANG['cfg_desc']['share_img'] =  '请上传jpg,jpeg或gif格式背景图片,宽高建议60*60';



$_LANG['cfg_name']['qiandao'] = '是否开启签到赠送积分';

$_LANG['cfg_range']['qiandao']['1'] = '开启';

$_LANG['cfg_range']['qiandao']['0'] = '关闭';

$_LANG['cfg_name']['remind_info'] = '自提提醒';

$_LANG['cfg_name']['index_show_team_num'] = '首页拼团专区显示数量';

$_LANG['cfg_name']['cat_type'] = '分类页模板样式';
$_LANG['cfg_range']['cat_type']['1'] = '精简版';
$_LANG['cfg_range']['cat_type']['0'] = '综合版';

$_LANG['cfg_name']['index_show_mall_num'] = '首页精品商城显示数量';

$_LANG['cfg_name']['qiandao_integral'] = '签到送积分';

$_LANG['cfg_name']['shb_title'] = '好友券分享标题';
$_LANG['cfg_name']['shb_desc'] = '好友券分享介绍';

$_LANG['cfg_name']['juhekey'] = '聚合数据快递接口key';
$_LANG['cfg_desc']['juhekey'] = '接口申请地址 <a href="https://www.juhe.cn/docs/api/id/43" target="_blank">https://www.juhe.cn/docs/api/id/43</a>';


$_LANG['cfg_name']['start_time'] = '自提开始时间';
$_LANG['cfg_name']['end_time'] = '自提结束时间';

$_LANG['cfg_desc']['start_time'] =  '以小时为单位';
$_LANG['cfg_desc']['end_time'] =  '以小时为单位';
