...
?>
  ...
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    ...
    <td width="200" align="left" class="first-cell nowrap" valign="top" >
    ...
    <td width="100" class="nowrap" align="center" valign="top">
    ...
    <td valign="top">
      ...
      <?php if ($this->_var['cat']['weixin_key']): ?><?php echo htmlspecialchars($this->_var['cat']['weixin_key']); ?><?php else: ?><font color=red style="float:left;width:600px;"><?php echo $this->_var['cat']['links']; ?></font><?php endif; ?>

    </td>

    <td width="100" class="nowrap" valign="top"><span onclick="listTable.edit(this, 'edit_sort_order', <?php echo $this->_var['cat']['cat_id']; ?>)"><?php echo $this->_var['cat']['sort_order']; ?></span></td>

    <td width="200" class="nowrap" valign="top">
